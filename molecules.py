...
class Molecule(Hashable):
    ...
    apex_cleaned_smiles: Optional[str] = field(init=False, default=None)
    ...
    def _clean_apex_smiles(self):
        ...
        """
        if self.apex_smiles and self.rdkit_molecule:
            standardizer = Standardizer()
            self.super_parent_mol = standardizer.super_parent(self.rdkit_molecule)
            self.apex_cleaned_smiles = Chem.MolToSmiles(self.super_parent_mol)
            return
    ...
    def get_clean_apex_smiles(self) -> Optional[str]:
        ...
        """
        return self.apex_cleaned_smiles
